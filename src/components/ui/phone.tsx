...
export const PhoneInput = ({ value, onChange, disabled, readOnly, placeholder, defaultCountry = 'ca', className }: PhoneInputProps) => {
  return (
    <div className={cn('flex items-center rounded-md border border-input bg-transparent h-10 transition-all', disabled && 'opacity-70 cursor-not-allowed bg-muted', className)}>
      <PhoneInput2
        ...
        dropdownClass='!z-50 !rounded-md !shadow-md !border !border-border'
      />
    </div>
  );
};
